...
filepath = "weights-best-rescaled-minmax.hdf5"
...
with open("rescaled-minmax-model.json", "w") as json_file:
    json_file.write(model_json)

# load json and create model
print('\n loading saved model from file...')
json_file = open('rescaled-minmax-model.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = m_f_j(loaded_model_json)
# load weights into new model
print('\n loading saved best model weights from file...')
loaded_model.load_weights("weights-best-rescaled-minmax.hdf5")
print("\n compiling model...")

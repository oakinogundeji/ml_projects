...
from sklearn.linear_model import LogisticRegression as gnb
...
X_train, X_validation, Y_train, Y_validation = m_s.train_test_split(rescaledX, Y, test_size=validation_size, random_state=seed)
...
# GNB performed best
print('\n')
print('running GNB model i.e. best performing model on validation data....')
print('\n')
gnb = GNB()
# first fit the gnb instance against the entire training dataset
